...
| :--- | :--- | :--- | :--- |
| **Windows** (64-bit) | `NaukriUpdate-Setup-<version>.exe` | `NaukriUpdate-Setup-1.0.2.exe` | `.exe` |
| **macOS** (Intel / Apple Silicon) | `NaukriUpdate-<version>.dmg` | `NaukriUpdate-1.0.2.dmg` | `.dmg` |
| **Ubuntu / Debian / Linux Mint / Pop!_OS** | `naukri-update_<version>_amd64.deb` | `naukri-update_1.0.2_amd64.deb` | `.deb` |
| **Fedora / Arch / openSUSE / Other Linux** | `NaukriUpdate-<version>.AppImage` | `NaukriUpdate-1.0.2.AppImage` | `.AppImage` |
...
3. Run the installation command:
   ```bash
   sudo dpkg -i ./naukri-update_1.0.2_amd64.deb
   ```
   *(Or if using APT, run `sudo apt install --reinstall ./naukri-update_1.0.2_amd64.deb` to force overwriting existing files.)*
   *(Replace `naukri-update_1.0.2_amd64.deb` with the actual filename if different.)*
...
3. Download `naukri-update_1.0.2_amd64.deb`.
4. Open your **Downloads** folder.
5. Double-click `naukri-update_1.0.2_amd64.deb`.
6. Click **Install**.
